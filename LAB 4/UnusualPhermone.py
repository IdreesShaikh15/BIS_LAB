...
if __name__ == "__main__":
    ...
    # Using your existing setup and code from above...

    # Very low pheromone initialization
    initial_pheromone_low = 0.0001
    aco_low = AntColony(distances, n_ants=10, n_iterations=50, alpha=5.0, beta=1.0, rho=0.5, initial_pheromone=0.0001)
    best_route_low, best_distance_low = aco_low.run()
    print("Low initial pheromone:")
    print("Best route found:", best_route_low)
    print("Best distance:", best_distance_low)
    print("\n" + "-"*50 + "\n")

    # Very high pheromone initialization
    initial_pheromone_high = 1000
    aco_high = AntColony(distances, n_ants=10, n_iterations=50, alpha=5.0, beta=1.0, rho=0.5, initial_pheromone=1000)
    best_route_high, best_distance_high = aco_high.run()
    print("High initial pheromone:")
    print("Best route found:", best_route_high)
    print("Best distance:", best_distance_high)
